# network/resnet38d_baseline.py
# Đây là phiên bản ResNet-38 gốc, đã loại bỏ module ESF của tác giả.

import torch
from torch import nn
import torch.nn.functional as F

# Các lớp ResBlock và ResBlock_bot là kiến trúc ResNet-38 gốc, giữ nguyên
